        ...
        <div class="row">
            <div class="col-xl">
                <div class="card mb-6">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.coupons.update', $coupon->id) }}" enctype="multipart/form-data" method="post">
                            @csrf
                            @method('patch')
                            <div class="row">
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="title" id="title" value="{{ $coupon->title }}" required >
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="code" id="code" placeholder="{{ \Illuminate\Support\Str::random(8) }}" value="{{ $coupon->code }}" required >
                                    <span class="text-danger">{{ $errors->has('code') ? $errors->first('code') : '' }}</span>
                                </div>

                                <div class="mb-4 col-md-6">
                                    <label class="form-label" for="start_date">Start Date <i class="text-danger">*</i></label>
                                    <input type="date" class="form-control" name="start_date" id="start_date" value="{{ $coupon->start_date }}" required >
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="date" class="form-control" name="end_date" id="end_date" value="{{ $coupon->end_date }}" required >
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="number" class="form-control" name="discount" id="discount" value="{{ $coupon->discount }}" required >
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="number" class="form-control" name="min_purchase" id="min_purchase" value="{{ $coupon->min_purchase }}" required >
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="number" class="form-control" name="max_discount" id="max_discount" value="{{ $coupon->max_discount }}" required >
