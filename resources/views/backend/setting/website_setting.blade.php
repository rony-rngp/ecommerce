                        ...
                        <form action="{{ route('admin.website_settings') }}" enctype="multipart/form-data" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <select name="email_verification" id="email_verification" class="form-control">
                                        <option value="">Select One</option>
                                        <option {{ get_settings('email_verification') == 1 ? 'selected' : '' }} value="1">Enable</option>
                                        <option {{ get_settings('email_verification') == 0 ? 'selected' : '' }} value="0">Disable</option>
                                    </select>
                                    <span class="text-danger">{{ $errors->has('email_verification') ? $errors->first('email_verification') : '' }}</span>
                                </div>
