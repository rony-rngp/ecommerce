                        ...
                        <form action="{{ route('admin.pages.update', $page->id) }}" enctype="multipart/form-data" method="post">
                            ...
                            <div class="row">
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="page_name" id="page_name" value="{{ $page->page_name }}" required >
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="text" style="background-color: #f6f6f6;" readonly class="form-control" name="slug" id="slug" value="{{ $page->slug }}" required >
                                ...
                                <div class="mb-4 col-md-12">
                                    ...
                                    <textarea name="content" required id="hidden-textarea" style="display: none">{{ $page->content }}</textarea>
