                        ...
                        <form action="{{ route('admin.products.store') }}" enctype="multipart/form-data" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-4 col-md-12">
                                    ...
                                    <textarea name="description" required id="hidden-textarea" style="display: none">{{ old('description') }}</textarea>
                                ...
                                <div class="col-md-12 mb-4 ">
                                    <div class="form-check mt-6">
                                        <input class="form-check-input" type="checkbox" value="1" name="has_attribute" id="has_attribute" >
                                        <label class="form-check-label" for="has_attribute"> Has Attribute </label>
                                    </div>
                                </div>

                                <div class="mb-4 col-md-6" id="stock_div">
                                ...
                                <div class="col-md-12 mb-4 d-none" id="attribute_div">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <input type="text" name="attribute_title" class="form-control" id="attribute_title" value="{{ old('attribute_title') }}">
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <label class="form-label" for="price">Price <i class="text-danger">*</i></label>
                                                    <input type="number" step="any" name="att_price[]" class="form-control" id="att_price">
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="form-label" for="stock">Stock <i class="text-danger">*</i></label>
                                                    <input type="number" name="att_stock[]" class="form-control" id="att_stock">
                                                </div>

                                                <div id="newRow2" class="mt-4" style="width: 100%"></div>
                                ...
                                <div class="mb-4 col-md-12">
                                    ...
                                    <div>
                                        ...
                                        <div class="form-check form-check-inline mt-3">
                                            <input class="form-check-input" type="checkbox" name="color_id[]" id="color_id{{ $color->id }}" value="{{ $color->id }}">
                                ...
                                <div class="mb-4 col-md-6">
                                    <label class="form-label" for="image">Image (width:300px height: 338px) <i class="text-danger">*</i></label>
