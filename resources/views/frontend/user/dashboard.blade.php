                    ...
                    <div class="tab-content mb-6">
                        <div class="tab-pane active in" id="account-dashboard">
                            <p class="greeting">
                                ...
                                (not
                                <span class="text-dark font-weight-bold">{{ Auth::user()->name }}</span>?
                                <a href="logout" onclick="event.preventDefault();document.getElementById('logout-form').submit();" class="text-primary">Log out</a>)
                            ...
                            <p class="mb-4">
                                ...
                                manage your <a href="" class="text-primary link-to-tab">shipping
                                    and billing
                                    addresses</a>, and
                                <a href="" class="text-primary link-to-tab">edit your password </a> and
                                <a href="" class="text-primary link-to-tab">
                                    account details. </a>
                            </p>
