<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ request()->is('admin/categories*') || request()->is('admin/subcategories*') ? 'active open' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-list-ol"></i>
                <div class="text-truncate" data-i18n="Dashboards">Manage Category</div>
            </a>
            <ul class="menu-sub">
                ...
                <li class="menu-item {{ request()->is('admin/subcategories*') ? 'active' : '' }}">
                    <a href="{{ route('admin.subcategories.index') }}" class="menu-link">
                        <div class="text-truncate" data-i18n="Analytics">Sub Category</div>
                    </a>
                </li>
            </ul>
        </li>
        ...
        {{--<li class="menu-item {{ request()->is('admin/attributes*')  ? 'active open' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-adjust"></i>
                <div class="text-truncate" data-i18n="Dashboards">Manage Attribute</div>
            </a>
            <ul class="menu-sub">
                <li class="menu-item {{ request()->is('admin/attributes*') ? 'active' : '' }}">
                    <a href="{{ route('admin.attributes.index') }}" class="menu-link">
                        <div class="text-truncate" data-i18n="Analytics">Attribute</div>
                    </a>
                </li>
            </ul>
        </li>--}}
